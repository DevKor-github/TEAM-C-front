...
class FetchDataViewModel : ViewModel() {
    ...
    private val _secessionComplete = MutableLiveData<Boolean>()
    val secessionComplete: LiveData<Boolean> get() = _secessionComplete
    ...
    fun secessionUser() {
        ...
        service.secessionUser().enqueue(object : Callback<Void> {
