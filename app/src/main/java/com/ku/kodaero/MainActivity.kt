...
import com.ku.kodaero.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private var currentValidFragmentId: Int = R.id.fragment_home
    ...
    fun setBottomNavigationView() {
        binding.bottomNavigationView.setOnItemSelectedListener { item ->
            ...
            val requiresAuthentication = item.itemId == R.id.fragment_favorites || item.itemId == R.id.fragment_mypage
            if (!requiresAuthentication || accessToken != null) {
                currentValidFragmentId = item.itemId
            }
            ...
            when (item.itemId) {
                ...
                R.id.fragment_favorites -> {
                    if (accessToken == null) {
                        val dialog = LoginConfirmationDialog(this) {
                            handleLogin()
                        }

                        dialog.setOnDismissListener {
                            binding.bottomNavigationView.selectedItemId = currentValidFragmentId
                        }
