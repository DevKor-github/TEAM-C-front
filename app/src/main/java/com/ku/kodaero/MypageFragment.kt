...
import com.ku.kodaero.databinding.FragmentMypageBinding
...
class MypageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.termsPoliciesButton.setOnClickListener {
            navigateToTermsPoliciesFragment()
        }

        binding.secessionButton.setOnClickListener {
            navigateToSecessionFragment()
        }
    ...
    private fun navigateToTermsPoliciesFragment() {
        val termsPoliciesFragment = TermsPoliciesFragment()
        val transaction = requireActivity().supportFragmentManager.beginTransaction()
        transaction.add(R.id.main_container, termsPoliciesFragment)
        transaction.addToBackStack("TermsPoliciesFragment")
        transaction.commit()
    }

    private fun navigateToSecessionFragment() {
        val secessionFragment = SecessionFragment()
        val transaction = requireActivity().supportFragmentManager.beginTransaction()
        transaction.add(R.id.main_container, secessionFragment)
        transaction.addToBackStack("SecessionFragment")
        transaction.commit()
    }
