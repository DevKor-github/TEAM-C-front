...
object MarkerZoomLevelThreshold {
    ...
    val zoomToIdsMap: Map<Double, List<Int>> = mapOf(
        1.0 to listOf(48, 15, 2, 32, 21, 14, 13, 33, 44, 10, 24, 3, 18, 4, 43),  // 일부 ID만 포함
        15.0 to listOf(7, 12, 20, 1, 26, 35, 45, 46, 49, 50, 53, 55, 7 ,8 ,41), // 더 많은 ID 포함
    ...
    val availableBuildingList: List<Int> = listOf(
        1, 2, 3, 10, 12, 13, 14, 15, 17, 18, 20, 21, 25, 26, 29, 32, 33, 39, 48, 42, 44, 45, 46, 49, 50, 53, 55, 56, 4 ,7 ,8 ,41 ,43, 9, 28, 61
    )
}
